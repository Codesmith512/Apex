...
namespace io
{
  ...
  namespace screen
  {
    ...
    public:
       ...
       */
      void event(keyboard::event_t const& e);
    ...
    public:
      ...
      static void global_event(keyboard::event_t const& event);

    protected:

      /* Instanced Event Handler */
      void event(keyboard::event_t const& event);
